  ...
  ngOnInit(): void {
    ...
    this.checkOutFormGroup = this.formBuilder.group({
      customer: this.formBuilder.group({
        ...
        lastName: new FormControl('', [Validators.required, CustomValidators.notOnlyWhiteSpace]),
      ...
      Payment: this.formBuilder.group({
        ...
        name: new FormControl('', [Validators.required, CustomValidators.notOnlyWhiteSpace]),
